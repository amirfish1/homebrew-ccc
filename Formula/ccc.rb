class Ccc < Formula
  ...
  url "https://github.com/amirfish1/claude-command-center/archive/refs/tags/v5.25.1.tar.gz"
  sha256 "e8043034939c7f299dad84f32bd254635644609541d0e082ef2a5e1a2291ae85"
  license "MIT"
